...
static WMScaleMode *WMScaleModePersian = @"Persian";
static WMScaleMode *WMScaleModeLydianMinor = @"Lydian Minor";
static WMScaleMode *WMScaleModeHungarianMajor = @"Hungarian Major";
static WMScaleMode *WMScaleModeOkinawa = @"Okinawa";
static WMScaleMode *WMScaleModeInSenPou = @"In Sen Pou";
static WMScaleMode *WMScaleModeEightToneSpanish = @"Eight Tone Spanish";
static WMScaleMode *WMScaleModeLeadingWholeTone = @"Leading Whole Tone";
static WMScaleMode *WMScaleModeDiminishedWholeHalf = @"Diminished Whole Half";
static WMScaleMode *WMScaleModeAeolian = @"Aeolian";
static WMScaleMode *WMScaleModeHungarianMinor = @"Hungarian Minor";
static WMScaleMode *WMScaleModeAlteredScale = @"Altered Scale";
static WMScaleMode *WMScaleModeHarmonicMinor = @"Harmonic Minor";
static WMScaleMode *WMScaleModePrometheus = @"Prometheus";
static WMScaleMode *WMScaleModeEnigmatic = @"Enigmatic";
static WMScaleMode *WMScaleModeGagakuRyoSenPou = @"GAGAKU Ryo Sen Pou";
static WMScaleMode *WMScaleModeGagakuRittsuSenPou = @"GAGAKU Rittsu Sen Pou";
static WMScaleMode *WMScaleModeArabian = @"Arabian";
...
static WMScaleMode *WMScaleModeHungarianGypsy = @"Hungarian Gypsy";
...
static WMScaleMode *WMScaleModeEastIndianPurvi = @"East Indian Purvi";
static WMScaleMode *WMScaleModeDiminishedHalfWhole = @"Diminished Half Whole";
static WMScaleMode *WMScaleModeLocrian = @"Locrian";
static WMScaleMode *WMScaleModeDorian = @"Dorian";
static WMScaleMode *WMScaleModeZokugakuYoSenPou = @"ZOKUGAKU Yo Sen Pou";
static WMScaleMode *WMScaleModeBalinese = @"Balinese";
static WMScaleMode *WMScaleModeNeapolitanMinor = @"Neapolitan Minor";
...
static WMScaleMode *WMScaleModeOvertone = @"Overtone";
static WMScaleMode *WMScaleModeDoubleHarmonic = @"Double Harmonic";
static WMScaleMode *WMScaleModeByzantine = @"Byzantine";
static WMScaleMode *WMScaleModeHarmonicMajor = @"Harmonic Major";
static WMScaleMode *WMScaleModeOriental = @"Oriental";
static WMScaleMode *WMScaleModeSixToneSymmetrical = @"Six Tone Symmetrical";
static WMScaleMode *WMScaleModeMajorLocrian = @"Major Locrian";
static WMScaleMode *WMScaleModeNeapolitanMajor = @"Neapolitan Major";
