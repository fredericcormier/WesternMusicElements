...
- (void)prepareScales {
    ...
    int CAeolianScaleValues[8]          = {0,2,3,5,7,8,10,12};
    int CLocrianScaleValues[8]          = {0,1,3,5,6,8,10,12};
    int CGypsyMinorScaleValues[8]       = {0,2,3,6,7,8,11,12};
    int CWholeToneScaleValues[7]        = {0,2,4,6,8,10,12};
    int CPentatonicMajorScaleValues[6]  = {0,2,4,7,9,12};
    int CPentatonicMinorScaleValues[6]  = {0,3,5,7,10,12};
